...
env = CartPoleButter(Te=Te, N_STEPS=EP_STEPS, discreteActions=True, tensionMax=8.4706, resetMode=resetMode, sparseReward=False,f_a=0,f_c=0,f_d=0, kPendViscous=0.0)

no_buckets = (1,1,6,6,3)
...
def select_explore_rate(x):
    ...
    return max(min_learning_rate, min(1.0, 1.0 - math.log10((x+1)/10000)))

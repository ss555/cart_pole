...
env = CartPoleButter(Te=0.02,discreteActions=False,N_STEPS=800,f_a=-7.794018686563599, f_b=0.37538450501353504, f_c=-0.4891760779740128, f_d=-0.002568958116514183,sparseReward=False,tensionMax=12)#integrator='rk4')#
	...
	try:
		...
		with ProgressBarManager(STEPS_TO_TRAIN) as cus_callback:
			model.learn(total_timesteps=STEPS_TO_TRAIN, log_interval=100, #tb_log_name="normal",
						callback=[cus_callback, eval_callback])#TODO callback save
			if NORMALISE:
				#WHEN NORMALISING

...
def cbf(gpio, level, tick):
	...
	print('fin course')
	lock.release()	
pi.set_glitch_filter(17, 2)
pi.set_glitch_filter(18, 2)
...
def getVitChariot():
    global posChariot, oldPosChariot, old_time_chariot,Te    
    vitChariot = ((posChariot-oldPosChariot)/Te)
    oldPosChariot = posChariot
    return vitChariot
    
def getVitPendule():
	global posPendule, oldPosPendule, old_time_pendule,Te

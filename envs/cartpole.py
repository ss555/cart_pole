...
to
use
with DQN) or continous ("False" to use with SAC)
:param
resetMode: experimental, goal, random or random_theta_thetaDot
:param
length: longeur
du
pendule
...
of
motor
Force = f_a * Speed + f_b * Vmotor + f_c * np.sign(Speed) + f_d(look
report
for more details)
:param
f_b: coefficient
of
proportionality
for the motor Tension
:param
f_c: static
friction
for the motor movement which comprises friction of motor, reductor and cart
:param
f_d: assymmetry
coefficient in the
motor
...
pendule
:param
kPendViscous: viscous
friction
of
a
pendulum
:param
integrator: semi - euler(fast) or ode(long
but
more
precise
simulation)
...
semi - euler
integrator
for the simulation, to increase the precision
:param
Kp: Noise
process
standard
deviation
error
for the pendulum, the more elevated Kp is, the more noisy will be the system
:param
sparseReward: weather
to
train
with Sparse or Informative rewards
:param
Km: Noise
measurement
standard

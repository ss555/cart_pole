...
if __name__ == "__main__":
	try:
		...
		while 1:
			...
			#oscillations(amplitude,n_repetitions,PWM_magnitude)
...
ax.set(xlabel='time (s)', ylabel='angle (degrees)',
       title='Pendulum angle evolution with time')
ax.grid()

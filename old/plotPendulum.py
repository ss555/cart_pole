...
def getVitPendule():
	global oldPosPendule,posPendule,old_time_pendule,timesVitesseP,arrVitesseP
	vitPendule = ((posPendule-oldPosPendule)/(time.time()-old_time_pendule))
	old_time_pendule=time.time()
	timesVitesseP.append(time.time()-start_time)
...
if __name__ == "__main__":
	try:
		...
		plt.plot(timesVitesseP,arrVitesseP,'r-')

...
def main(env, gamma=0.9999, lr=1e-2, min_episodes=20, eps=1, eps_decay=0.998, eps_min=0.01, update_step=10, batch_size=4048,
         update_repeats=50,
         num_episodes=3000, seed=42, max_memory_size=50000, lr_gamma=0.9, lr_step=100, measure_step=100,
         measure_repeats=100, hidden_dim=256, cnn=False, horizon=np.inf, render=False, render_step=50):
    """

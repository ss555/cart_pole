...
fig.add_trace(go.Scatter(x=timeArr,y=x_dot, mode="lines"))#,label='Xd')
fig.add_trace(go.Scatter(x=timeArr,y=x_dotF), row=1, col=1)#,label='XdF')
fig.add_trace(go.Scatter(x=timeArr,y=theta_dot), row=3, col=1)#,label='Xd')
fig.add_trace(go.Scatter(x=timeArr,y=theta_dotF), row=3, col=1)#,label='XdF')
fig.add_trace(go.Scatter(x=xf,y=abs(yf)), row=2, col=1)#,label='fft')
fig.add_trace(go.Scatter(x=xf,y=abs(yf2)), row=2, col=1)#,label='fft2')

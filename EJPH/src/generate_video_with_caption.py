...
# inferenceName = ['./EJPH/real-cartpole/dqn_7.1V/inference_results.npz','./weights/dqn50-real/pwm51/inference_results.npz']
videoInfFilename = ['./EJPH/dqn7inf.mp4', './EJPH/dqn2.4inf.mp4']

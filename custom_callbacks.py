...
class CheckPointEpisode(BaseCallback):
    ...
    '''
    def __init__(self, save_freq_ep: int=10, save_path: str=None, episodes_init: int = 0):
        '''
        :param save_freq_ep:
        :param save_path: folder to save
        :param episodes_init : from which episode do we start?
        '''
        super(CheckPointEpisode, self).__init__()
        self.save_path = save_path
        self.save_freq_ep = save_freq_ep
        self.n_episodes = episodes_init
    def _init_callback(self) -> None:

...
pi.set_glitch_filter(19, ENCODER_GLITCH)
pi.set_glitch_filter(26, ENCODER_GLITCH)
#pi.set_glitch_filter(20, 50)
#pi.set_glitch_filter(21, 50)	 
...
plt.plot(times,posArrChariot,label='position chariot')
plt.plot(timesTension,arrTensions,label='tension chariot')
plt.plot(timesVitesse,arrVitesse,label='vitesse chariot')
